#!/usr/bin/env python3
"""
Dynamic RAG CLI - Enhanced RAG system with advanced features
Features:
- Persistent conversation memory
- Incremental indexing (only reindex changed files)
- Metadata filtering (file paths, function names, etc.)
- Code-specific chunking (AST parsing for Python)
- Collections/namespaces support
...
class DynamicRAG:
    ...
    def chat(self):
        ...
        print("\n" + "="*60)
        print("💬 Dynamic RAG - Enhanced Chat Interface")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Dynamic RAG CLI - Enhanced RAG with advanced features"
    )
    parser.add_argument(
        "--documents",
        type=str,
